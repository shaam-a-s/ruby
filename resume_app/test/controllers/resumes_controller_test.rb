...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference("Resume.count") do
      post resumes_url, params: { resume: { education: @resume.education, email: @resume.email, name: @resume.name, phone: @resume.phone, skills: @resume.skills, summary: @resume.summary } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { education: @resume.education, email: @resume.email, name: @resume.name, phone: @resume.phone, skills: @resume.skills, summary: @resume.summary } }
